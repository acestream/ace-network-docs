...
Эффект «Carbon Negative» достигается за счет снижения нагрузки с дата-центров/CDN и ее перераспределения между устройствами потребителей контента, которые не несут никакой дополнительной нагрузки. В итоге, когда кто-то потребляет контент посредством Ace Stream, то тем самым происходит уменьшение объемов CO2 в атмосфере, так как при отсутствие Ace Stream потребление этого контента произошло бы в любом случае, но только уже посредством стандартных технологий unicast, при соответствующим таким технологиям объемам выбросов CO2.
...
_Каждый, кто осуществляет стриминг, смотрит видео и слушает музыку онлайн посредством стандартных технологий unicast и не использует для этих целей Ace Stream, при этом заявляя, что ему небезразлична экология и уровень выбросов CO2 - подобен тому, кто заявляет, что он вегетарианец (веган), но при этом постоянно ест мясо!_
