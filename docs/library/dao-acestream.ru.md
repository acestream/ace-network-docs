...
[**Ace Asset (XAS)**][3] - токен управления протоколами сети Ace Network и обеспеченный активами Ace Stream DAO, дающий право на участие в распределении системных токенов (XAB) и комиссионных сборов получаемых Ace Stream DAO за услуги и сервисы, предоставляемые Сетью.
