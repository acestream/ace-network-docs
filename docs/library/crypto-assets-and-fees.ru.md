...
100,000,000,000 Ace Byte ([XAB][1]) - базовый криптоактив, который распределяется между участниками DeFi программы [Ace Assets][6], в соответствии условиям системных смарт контрактов.

Платежи за услуги и сервисы сети Ace Network, производимые в токенах Ace Time ([XAT][7]), являются криптоактивами DAO Ace Stream и распределяются между участниками DeFi программы [Ace Assets][6], в соответствии условиям системных смарт контрактов.
