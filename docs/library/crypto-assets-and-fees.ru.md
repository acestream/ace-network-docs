...
Платежи за услуги и сервисы сети Ace Network, производимые в токенах Ace Time ([XAT][7]), являются криптоактивами Ace Stream DAO и распределяются между участниками DeFi программы [Ace Assets][6], в соответствии условиям системных смарт контрактов.
