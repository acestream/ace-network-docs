...
Tokens from [`lockedPool`][1] are unlocked when DAO assets are created and increased, and at the moment of burning a similar amount of XATs within following smart contracts:
