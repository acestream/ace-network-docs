...
**Ace Token (XAT)** - утилитарный (utility), базовый системный токен, обеспеченный каналами пропускной способности Ace Stream P2P CDN, свыше 200000 Tbps, премиальным контентом и всеми сервисными услугами сети Ace Network.
...
количества XAT в рамках работы смарт-контрактов [System Service Payment][12] и
...
По окончанию проведения приватного токенсейла приобрести токены можно будет непосредственно на открытой торговой площадке Ace Stream, по рыночной цене, но не ниже номинала (1 XAT >= 1$).
